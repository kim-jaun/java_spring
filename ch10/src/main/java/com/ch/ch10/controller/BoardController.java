...
import com.ch.ch10.service.PageBean;
@Controller
public class BoardController {
	...
	public String view(@PathVariable int num, @PathVariable String pageNum,
	...
	public String updateForm(@PathVariable int num,@PathVariable String pageNum,
			Model model) {
		Board board = bs.select(num);
	...
	@RequestMapping("/list")
	public String list() {
//	redirect 또는 forward는 jsp로 가는 것이 아니라 Controller의 RequestMapping을 찾는다
		return "redirect:/list/pageNum/1";
	}
	// {pageNum} pageNum에 해당하는 값, 읽을 때는 @PathVariable
