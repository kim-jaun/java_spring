...
create table replyBoard (
	...
	bno number not null references board2(num),
...
insert into replyBoard values(1,463,'대박','박보검',sysdate,sysdate);
insert into replyBoard values(2,463,'사건','세정',sysdate,sysdate);