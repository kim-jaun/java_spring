...
<body>
	<form action="newComPw.do" name="frm" method="post"
		...
		<div class="card w-100 text-center">
			<div class="card-body">
				...
				<div class="form-floating mb-3">
					<input type="password" name="com_password" class="form-control passchk"
						id="pass" placeholder="Password"> <label
						for="pass">비밀번호</label>
				</div>
				<h6>비밀번호를 다시 한번 더 확인해주세요.</h6>
				<div class="form-floating mb-3">
					<input type="password" name="com_password2" class="form-control passchk"
